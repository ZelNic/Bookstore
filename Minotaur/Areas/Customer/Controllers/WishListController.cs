...
//            WishList? wishList = await _db.WishLists.Where(u => u.UserId == _user.Id).FirstOrDefaultAsync();
...
//        {
//            WishList? wishList = _db.WishLists.Where(i => i.UserId == _user.Id).FirstOrDefault();
//            if (wishList == null)
//                return NotFound();
